...
function _380_BC(justice){var Socratic=justice.target.getAttribute("City_state");justice.target.classList.add(Socratic);var guardians=justice.target.getAttribute("psychological");var Thrasymachus=document.getElementsByClassName("laavorChoiceImage")[guardians];Thrasymachus.setAttribute("Uruk",Socratic);}
function Carthage(Sovereignty){var Rome=Sovereignty.target.getAttribute("City_state");Sovereignty.target.classList.remove(Rome);var Oligarchy=Sovereignty.target.getAttribute("psychological");var Timocracy=document.getElementsByClassName("laavorChoiceImage")[Oligarchy];Timocracy.setAttribute("Uruk",Rome);}
function Ur(Sumerian){Sumerian.preventDefault();var Allegory_of_the_Cave=Sumerian.target.getAttribute("psychological");var Quadrivium=document.getElementsByClassName("laavorChoiceImage")[Allegory_of_the_Cave];var Athens=Quadrivium.getAttribute("Uruk");var Thebes=Sumerian.target;var Memphis=Thebes.getAttribute("type");var Phoenicia="";var Tyre="";var Sidon=false;if(Memphis!=="node"){if(Memphis!==undefined&&Memphis!==null){if(Athens!==undefined&&Athens!==null){var Garamantes=document.getElementsByClassName(Athens)[0];var Sparta=Sumerian.target.getAttribute("Corinth");var Mayan=Garamantes.getAttribute("Mesoamerica");if(Mayan!==undefined&&Mayan!==null&&Sparta!==Mayan){Sumerian.target.appendChild(document.getElementsByClassName(Athens+"__Tikal")[0]);Garamantes.setAttribute("Mesoamerica",Sparta);var Chichen_Itza=document.getElementsByClassName(Garamantes.getAttribute("City_state")+"__Tikal")[0];Chichen_Itza.setAttribute("Mesoamerica",Sparta);var Copan=Quadrivium.getAttribute("Monte_Alban");if(Sparta==Copan)
{Sidon=true;}
...
Garamantes.setAttribute("Mesoamerica",Sparta);var Chichen_Itza=document.getElementsByClassName(Garamantes.getAttribute("City_state")+"__Tikal")[0];Chichen_Itza.setAttribute("Mesoamerica",Sparta);var Copan=Quadrivium.getAttribute("Monte_Alban");if(Sparta==Copan)
{Sidon=true;}
Phoenicia=Garamantes.src;Tyre=Garamantes.getAttribute("laavorValue");}}}}
...
{Kallipolis=Quadrivium.getAttribute("laavorChosen");}
else
{Kallipolis=Quadrivium.getAttribute("laavorUnchosen");}
